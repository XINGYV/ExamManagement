...
import com.exammanagement.common.util.QuestionAdapter;
...
public class ExamPageAdmin {
    ...
    @RequestMapping(value = "/admin/admin/exam/mark-exampaper/{examhistoryId}", method = RequestMethod.GET)
    private String markExampaperPage1(Model model, HttpServletRequest request, @PathVariable int examhistoryId) {
