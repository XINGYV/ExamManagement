...
import com.exammanagement.common.domain.practice.KnowledgePointAnalysisResult;
import com.exammanagement.common.domain.practice.TypeAnalysis;
...
import com.exammanagement.common.util.PagingUtil;
...
@Controller
public class TrainingPageTeacher {
     ...
     * @return
     */
    @RequestMapping(value = "/teacher/training/training-list", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/teacher/training/training-add", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/teacher/training/student-practice-status/{userId}", method = RequestMethod.GET)
    public String practiceStatusDefaultPage(Model model, HttpServletRequest request, @PathVariable int userId) {
        List<Field> fieldList = questionService.getAllField(null);
        return "redirect:/teacher/training/student-practice-status/" + fieldList.get(0).getFieldId() + "/" + userId;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/teacher/training/student-practice-status/{fieldId}/{userId}", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/teacher/training/student-training-history/{trainingId}", method = RequestMethod.GET)
     ...
     * @return
     */
    @RequestMapping(value = "/teacher/training/section-list/{trainingId}", method = RequestMethod.GET)
