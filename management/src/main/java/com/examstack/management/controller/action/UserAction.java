...
import com.exammanagement.common.domain.user.Group;
import com.exammanagement.common.domain.user.User;
import com.exammanagement.common.util.StandardPasswordEncoderForSha1;
...
public class UserAction {
    ...
    public @ResponseBody
    Message addUser(@RequestBody User user, @PathVariable String authority,
    ...
    public @ResponseBody
    Message addGroup(@RequestBody Group group) {
    ...
    public @ResponseBody
    Message resetUserPwd(Model model, @PathVariable("password") String password, @PathVariable("userName") String userName) {
        UserInfo userInfo = (UserInfo) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    ...
    public @ResponseBody
    Message changeUserStatus(Model model, @PathVariable("userId") int userId, @PathVariable("enabled") boolean enabled) {
    ...
    public @ResponseBody
    Message modifyGroup(@PathVariable("groupId") int groupId, @PathVariable("groupName") String groupName) {
        Message msg = new Message();
        try {
    ...
    public @ResponseBody
    Message deleteGroup(@PathVariable("groupId") int groupId) {
        Message msg = new Message();
        try {
    ...
    public @ResponseBody
    Message addUserGroup(@PathVariable("userId") int userId, @PathVariable("groupId") int groupId) {
    ...
    public @ResponseBody
    Message addUserGroupWithUserNameList(@RequestBody String userNames, @PathVariable("groupId") int groupId) {
        Message msg = new Message();
        UserInfo userInfo = (UserInfo) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        try {
    ...
    public @ResponseBody
    Message addUserGroupWithUserNameList(@PathVariable("userId") int userId, @PathVariable("groupId") int groupId) {
        Message msg = new Message();
        UserInfo userInfo = (UserInfo) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        try {
