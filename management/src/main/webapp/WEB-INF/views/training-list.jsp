        ...
        <div class="row">
            ...
            <div class="col-xs-10" id="right-content">
                <div class="page-header">
                    <h1><i class="fa fa-bar-chart-o"></i> 课程管理 </h1>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="training-sections"
                                               data-id="${item.trainingId }">${item.trainingName }</a>

                                            <p>${item.creatorName } <i class="fa fa-clock-o"></i><fmt:formatDate
                                                    value="${item.createTime }" pattern="yyyy-MM-dd HH:mm"/></p>
                                        </td>
                                ...
                                <div class="modal-body">
                                    <form id="section-add-form" style="margin-top:40px;" action="secure/add-user">
                                        ...
                                        <div class="form-line add-section-file">
                                            ...
                                            <span class="form-message">请上传mp4文件</span>
                                        </div>
                                    </form>
                                </div>
