										...
										<c:forEach items="${histList }" var="item">
											<tr>
												...
												<td>
													...
													<c:if test="${item.approved == 3 }">
													<!-- S<a target="_blank" href="<%=list[1]%>/exam/student-answer-sheet/${item.histId}">查看答卷</a> -->
														<a class="btn btn-success btn-sm" href="<%=list[1]%>/exam/student-answer-sheet/${item.histId}" target="_blank">查看答卷</a>
													</c:if>
												</td>
											</tr>
										</c:forEach>
