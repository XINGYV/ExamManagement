    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="copy">
                    <p>
                        ExamManagement Copyright © 2018 - 考试管理系统
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="add-user-btn" data-action="admin/add-user-ROLE_TEACHER"
                            data-url="admin/user/teacher-list" data-group="0" type="button" class="btn btn-primary">
                        确定添加
                    </button>
                </div>
            </div>
