                        ...
                        <div class="table-controller">
                            <div class="btn-group table-controller-item" style="float:left">
                                <button class="btn btn-default btn-sm" id="add-teacher-modal-btn">
                                    <i class="fa fa-plus-square"></i> 创建管理员账号
                                </button>
                            </div>
                        </div>
                        <table class="table-striped table">
                            ...
                            <c:forEach items="${userList }" var="item">
                                <tr>
                                    ...
                                    <td><span class="r-update-btn btn-sm btn-success" data-id="21321"
                                              data-depid="${item.depId }">修改</span><span
                                            class="disable-btn btn-sm btn-danger" data-id="${item.userId }"
...
<footer>
    ...
    <div class="modal fade" id="add-teacher-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h6 class="modal-title" id="myModalLabel">创建管理员账号</h6>
                </div>
                <div class="modal-body">
                    <form id="teacher-add-form" style="margin-top:40px;" action="admin/add-admin">
                ...
                <div class="modal-footer">
                    ...
                    <button id="add-user-btn" data-action="admin/add-admin" data-url="admin/system/admin-list"
                            data-group="0" type="button" class="btn btn-primary">
                        确定添加
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade" id="reset-pwd-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="reset-pwd-form" style="margin-top:40px;" action="secure/reset-pwd-user">
                        <div class="form-line form-user-name-reset">
                            <span class="form-label"><span class="warning-label">*</span>用户名：</span>
                            <input type="text" class="df-input-narrow" id="username-reset" maxlength="20"
                                   disabled="disabled">
                            <span class="form-message"></span>
                            <br>
                        </div>
    ...
    <div class="modal fade" id="update-teacher-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h6 class="modal-title" id="myModalLabel">修改管理员账号</h6>
                </div>
                <div class="modal-body">
...
<script type="text/javascript" src="resources/js/add-admin.js"></script>
<script type="text/javascript" src="resources/js/update-admin.js"></script>
<script>
    $(function () {
