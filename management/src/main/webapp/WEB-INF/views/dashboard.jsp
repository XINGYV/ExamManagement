        ...
        <div class="row">
            <div class="col-xs-2" id="left-menu">
                <ul class="nav default-sidenav">
                    <li>
                        <a href="admin/question/question-add" title="添加试题"><i class="fa fa-plus">&nbsp;</i><span
                                class="left-menu-item-name"> 添加试题</span></a>
                    </li>
                    <li>
                        <a href="admin/exampaper/exampaper-add" title="创建新试卷"><i class="fa fa-leaf">&nbsp;</i><span
                                class="left-menu-item-name"> 创建新试卷</span></a>
                    <li>
                        <a href="admin/exam/exam-add" title="发布考试"><i class="fa fa-plus-square-o">&nbsp;</i><span
                                class="left-menu-item-name"> 发布考试</span></a>
                    </li>
                    <li>
                        <a href="admin/exam/model-test-add" title="发布模拟考试"><i class="fa fa-flag">&nbsp;</i><span
                                class="left-menu-item-name"> 发布模拟考试</span></a>
                    </li>
                </ul>
            </div>
            <div class="col-xs-10" id="right-content">
                <div class="page-header">
                    <h1><i class="fa fa-flash"></i> 控制面板 </h1>
                </div>
                <div class="page-content">
                    <div class="bs-example bs-example-bg-classes" data-example-id="contextual-backgrounds-helpers">
                        <p class="bg-success">
                            ...
                            欢迎使用ExamManagement考试管理系统，您可以在此页面快速查看您系统的状态。
                        </p>
