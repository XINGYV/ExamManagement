                ...
                <div class="page-content">
                    ...
                    <div id="question-filter">
                        ...
                        <div class="input-group search-form" style="float: left;width: 300px;padding: 10px 0px;">
                            <input type="text" class="form-control" placeholder="搜索试题" value="${searchParam }"
                                   id="txt-search">
                            <span class="input-group-btn">
										<button class="btn btn-sm btn-default" type="button" id="btn-search"
                                                data-id="0">
                                        ...
                                        <form id="question-edit-form">
                                            ...
                                            <div class="form-line question-knowledge">
                                                <span class="form-label"><span
                                                        class="warning-label">*</span>知识分类：</span>
                                                <div>
                                                    <div class="clearfix">
                                                    ...
                                                    <div style="text-align:center;margin:10px 0;">
                                                        <button id="add-point-btn" class="btn btn-primary btn-xs">
                                                            选择知识分类
                                                        </button>
                                                        <button id="del-point-btn" class="btn btn-danger btn-xs">
                                                            删除知识分类
                                                        </button>
                                                        <button id="remove-all-point-btn"
                                                                class="btn btn-warning btn-xs">清除列表
                                                        </button>
                                                    </div>
                                                    <div id="kn-selected"
                                            ...
                                            <div class="form-line form-question-analysis" style="display: block;">
                                                ...
                                                <textarea class="add-question-ta" style="width: 100%;"></textarea><span
                                                    class="form-message"></span>
                                                <br>
                                            </div>
