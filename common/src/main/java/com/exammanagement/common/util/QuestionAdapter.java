package com.exammanagement.common.util;
...
public class QuestionAdapter {
    ...
    /**
     * @param question            试题
     * @param answerSheetItem     答题卡
     * @param questionQueryResult 试题描述
     */
    ...
    /**
     * @param showAnswer   是否显示正确的答案。如果有答题卡，会显示用户的答案
     * @param showPoint    是否显示分数
     * @param showAnalysis 是否显示分析和来源
     * @return
     */
