...
function drawTable(table_entity) {
    ...
    for (var i = 0; i < questionlist.length; i++) {
        ...
        tablehtml = tablehtml + "<td><input type=\"checkbox\" value=\"" + questionlist[i].id + "\" /><input type=\"hidden\" value=\"" + questionlist[i].id + "\" /></td>";
        tablehtml = tablehtml + "<td>" + questionlist[i].id + "</td>";
        tablehtml = tablehtml + "<td><a href=\"teacher/question-detail/" + questionlist[i].id + "\" target=\"_blank\" title=\"预览\">" + questionlist[i].name + "</a></td>";
        ...
        tablehtml = tablehtml + "<td><a href=\"javascript:void(0);\" class=\"add-to-exampaper\">添加</a></td>";
