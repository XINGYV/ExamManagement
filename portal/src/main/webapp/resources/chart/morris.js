(function () {
    var $, Morris, minutesSpecHelper, secondsSpecHelper, __slice = [].slice, __hasProp = {}.hasOwnProperty,
    ...
    Morris.Grid = (function (_super) {
        ...
        Grid.prototype._calc = function () {
            ...
            if (this.elementWidth !== w || this.elementHeight !== h || this.dirty) {
                ...
                this.bottom = this.elementHeight - this.options.padding - 50;
