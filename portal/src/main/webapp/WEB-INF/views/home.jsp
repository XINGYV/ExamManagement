    ...
    <div class="container">
        <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="training-list"><i class="fa fa-book"></i>课程资料</a>
                </li>
                <li>
                    <a href="student/usercenter"><i class="fa fa-dashboard"></i>学员中心</a>
                </li>
                <li>
                    ...
                    <div class="flex-caption">
                        ...
                        <div class="col-l">
                            <p style="text-indent:2em;">
                                ExamManagement是国内一款基于JAVA与MYSQL开发的考试管理系统。它可以稳定、顺畅的运行在Windows平台上。您可以通过它快捷方便的创建试题和题库，发布试卷，组织考试，系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。
                            </p>
                            <p style="text-indent:2em;">
                                软件采用SSM框架，安全高效，扩展性强
                            </p>
                        ...
                        <div class="col-r">
                            ...
                            <p>
                                如果您对软件有任何反馈和建议，加入我们的QQ群16888一起讨论吧
                            </p>

                            <!-- Button -->
                            <a class="btn btn-default btn-cta" href="user-register"><i
                                    class="fa fa-arrow-circle-down"></i> 欢迎你的到来</a>
        ...
        <div class="row">
            ...
            <div class="select-test col-xs-4">
                ...
                <div style="text-align: center;margin-top:20px;">
                    <a class="btn btn-info quick-start-btn" href="quick-start">快速考试入口 <i
        ...
        <div class="row">
            <a class="field-category-div col-xs-3 home-link-anchor">
                ...
                <div class="field-category-footer">
                    ...
                    <div class="field-category-footer-sub">
                        ...
                        <span class="field-student-num">468</span>
            ...
            <a class="field-category-div col-xs-3 home-link-anchor">
                ...
                <div class="field-category-footer">
                    ...
                    <div class="field-category-footer-sub">
                        <i class="fa fa-users"></i>
                        <span class="field-student-num">2222</span>
                        名学员
                    </div>
            ...
            <a class="field-category-div col-xs-3 home-link-anchor">
                ...
                <div class="field-category-footer">
                    ...
                    <div class="field-category-footer-sub">
                        <i class="fa fa-users"></i>
                        <span class="field-student-num">1600</span>
                        名学员
                    </div>
                ...
                <li class="news-list-item clearfix">
                    <a class="home-link-anchor" href="news/${newsList[0].newsId }" target="_blank">
                        <div class="news-list-thumbnail">
                            <img src="/resources/images/index/index3.jpg">
                        </div>
                        <div class="news-list-content">
                            ...
                            <div class="news-list-creater">
                                ...
                                <i class="fa fa-clock-o"></i><span><fmt:formatDate value="${newsList[0].createTime }"
            ...
            <a class="home-link-anchor" href="news/${newsList[1].newsId }">
                ...
                <div class="news-list-content">
                    ...
                    <div class="news-list-creater">
                        ...
                        <i class="fa fa-clock-o"></i><span><fmt:formatDate value="${newsList[1].createTime }"
                                                                           pattern="yyyy-MM-dd HH:mm"/></span>
                    </div>
                </div>
            </a>
...
document.write(unescape("%3Cspan id='cnzz_stat_icon_1252987997'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s19.cnzz.com/z_stat.php%3Fid%3D1252987997' type='text/javascript'%3E%3C/script%3E"));</script>
</body>
</html>
