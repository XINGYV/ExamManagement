				...
				<div class="row">
					<div class="col-xs-2">
						<ul class="nav default-sidenav">
							...
							<li class="active">
								<a href="student/training-history"> <i class="fa fa-book"></i> 课程历史 </a>
							</li>
						</ul>
					</div>
					<div class="col-xs-10">
						<div class="page-header">
							<h1><i class="fa fa-history"></i> 课程历史</h1>
						</div>
						<div class="page-content row">
							<div id="question-list">
								<table class="table-striped table">
									<thead>
										<tr>
											<td>课程名称</td><td>学习进度</td><td>操作</td>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${trainingList }" var="item">
											<tr>
												...
												<td><a class="btn btn-success approved-btn" data-id="" href="student/training/${item.trainingId }">参加学习</a></td>
											</tr>
										</c:forEach>
