			...
			<div class="container" style="margin-top: 40px;">
				<div class="row">
						<div class="col-xs-12">
							...
							<h3 class="title"><i class="fa fa-book"></i>课程资料</h3>
							...
							<table class="table-striped table">
								...
								<tbody>
									<c:forEach items="${trainingList }" var="item">
										...
										<%-- 	<td><fmt:formatDate value="${item.expTime}"
													pattern="yyyy-MM-dd" /></td> --%>
											<td ><a class="btn btn-success approved-btn" data-id="${item.trainingId }" href="student/training/${item.trainingId }">学习</a></td>
