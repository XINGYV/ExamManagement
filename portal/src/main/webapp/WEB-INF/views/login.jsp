...
<head>
    ...
    <title>ExamManagement 登录系统</title>
                    ...
                    <div class="form">
                        ...
                        <form class="form-horizontal" action="j_spring_security_check" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3" for="username"><i class="fa fa-user"></i>&nbsp用户名</label>
                                <div class="col-md-9">
                            ...
                            <!-- Password -->
                            <div class="form-group">
                                <label class="control-label col-md-3" for="password"><i class="fa fa-key"></i>&nbsp密&nbsp&nbsp&nbsp码</label>
                                <div class="col-md-9">
