...
import com.exammanagement.common.domain.exam.*;
...
public class ExamPage {
    ...
    public String examFinishedPage(Model model, @PathVariable("examId") int examId) {
        ...
        ExamHistory history = examService.getUserExamHistByUserIdAndExamId(userInfo.getUserid(), examId, 2, 3);
        Gson gson = new Gson();
        List<QuestionQueryResult> questionList = gson.fromJson(history.getContent(), new TypeToken<List<QuestionQueryResult>>() {
        }.getType());
